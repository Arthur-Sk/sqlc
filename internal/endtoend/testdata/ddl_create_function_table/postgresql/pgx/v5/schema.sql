...
SELECT 1                                                                         as test_id,
       ...
       '{"name": "Test Station", "code": "Test Station"}'::jsonb::public.test_jsonb_domain as operation_test,
       'TST'                                                                     as operation_test_code,
       1                                                                         as operation_test_id,
       '123'                                                                     as test_number,
       '{"name": "Departure Station", "code": "Departure Station"}'::jsonb::public.test_jsonb_domain as departure_test,
       'DEP'                                                                     as departure_test_code,
       1                                                                         as departure_test_id,
       1                                                                         as index_number,
       '{"name": "Destination Station", "code": "Destination Station"}'::jsonb::public.test_jsonb_domain as destination_test,
